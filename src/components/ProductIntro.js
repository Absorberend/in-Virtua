      ...
      <div className="product__steps__container">
        <div className="product__step__wrapper">
          <img 
            src={eventIcon} 
            alt="add event" 
            className="product__step__icon" 
          />
          <p className="product__text product__bold">ipsum dolor sit amet</p>
          <p className="product__text">
            ipsum dolor sit amet consectetur adipiscing elit ut aliquam purus sit amet 
        ...
        <div className="product__step__wrapper">
          <img 
            src={vrIcon} 
            alt="order and receive VR headset" 
            className="product__step__icon" 
          />
          <p className="product__text product__bold">eget nulla facilisi</p>
          <p className="product__text">
            eget nulla facilisi etiam dignissim diam quis enim lobortis scelerisque fermentum dui 
        ...
        <div className="product__step__wrapper">
          ...
          <p className="product__text">
            at erat pellentesque adipiscing commodo elit at imperdiet dui accumsan sit amet nulla 
